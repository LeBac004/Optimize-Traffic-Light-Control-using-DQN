...
""")
    ...
    with open(f"{output_dir}/edges.edg.xml", "w", encoding="utf-8") as f:
        f.write("""<edges>
    <edge id="n2c" from="n" to="c" numLanes="1" speed="13.9"/>
    <edge id="s2c" from="s" to="c" numLanes="1" speed="13.9"/>
    <edge id="e2c" from="e" to="c" numLanes="1" speed="13.9"/>
    <edge id="w2c" from="w" to="c" numLanes="1" speed="13.9"/>

    <edge id="c2n" from="c" to="n" numLanes="1" speed="13.9"/>
    <edge id="c2s" from="c" to="s" numLanes="1" speed="13.9"/>
    <edge id="c2e" from="c" to="e" numLanes="1" speed="13.9"/>
    <edge id="c2w" from="c" to="w" numLanes="1" speed="13.9"/>
</edges>
""")
    ...
    <flow id="flow_n2s_moto" type="motorcycle" route="n2s" begin="0" end="3600" probability="0.15"/>
    <flow id="flow_n2s_car" type="car" route="n2s" begin="0" end="3600" probability="0.075"/>
    <flow id="flow_n2s_bus" type="bus" route="n2s" begin="0" end="3600" probability="0.025"/>
    
    <flow id="flow_s2n_moto" type="motorcycle" route="s2n" begin="0" end="3600" probability="0.15"/>
    <flow id="flow_s2n_car" type="car" route="s2n" begin="0" end="3600" probability="0.075"/>
    
    <flow id="flow_e2w_moto" type="motorcycle" route="e2w" begin="0" end="3600" probability="0.18"/>
    <flow id="flow_e2w_car" type="car" route="e2w" begin="0" end="3600" probability="0.09"/>
    <flow id="flow_e2w_truck" type="truck" route="e2w" begin="0" end="3600" probability="0.03"/>
    
    <flow id="flow_w2e_moto" type="motorcycle" route="w2e" begin="0" end="3600" probability="0.18"/>
    <flow id="flow_w2e_car" type="car" route="w2e" begin="0" end="3600" probability="0.09"/>
</routes>
""")
